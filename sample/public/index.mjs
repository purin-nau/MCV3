//import { default as GiiKER } from '../index.mjs';
//import { connect } from '../index.mjs';
//fs.readFile('../index.mjs');
...
button.addEventListener('click', async () => {
  ...
  giiker.on('move', (move) => {
    ...
    switch (`${move.notation}`) {
      case "U":
	//白
    	document.getElementById("ミ").currentTime = 0;
        //音声ファイル再生
    	document.getElementById("ミ").play();
 	break;
　　　case "U'":
    	document.getElementById("ファ").currentTime = 0;
        //音声ファイル再生
    	document.getElementById("ファ").play();
 	break;
      case "R": 
    	document.getElementById("ド").currentTime = 0;
        //音声ファイル再生
    	document.getElementById("ド").play();
	break;
      case "R'":
    	document.getElementById("レ").currentTime = 0;
        //音声ファイル再生
    	document.getElementById("レ").play();
	break;
      case "F":
    	document.getElementById("ソ").currentTime = 0;
        //音声ファイル再生
    	document.getElementById("ソ").play();
 	break;
　　　case "F'":
    	document.getElementById("ラ").currentTime = 0;
        //音声ファイル再生
    	document.getElementById("ラ").play();
 	break;
      case "D": 
    	document.getElementById("シ").currentTime = 0;
        //音声ファイル再生
    	document.getElementById("シ").play();
	break;
      case "D'":
    	document.getElementById("ド＋").currentTime = 0;
        //音声ファイル再生
